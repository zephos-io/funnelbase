...
var file_schema_test_proto_goTypes = []any{
...
func file_schema_test_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_schema_test_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_schema_test_proto_msgTypes[1].Exporter = func(v any, i int) any {
